...
// =======================
// Cambiar status disponible por false
// =======================
...
app.delete('/productos/:id', verificaToken, (req, res) => {
    ...
    Producto.findByIdAndUpdate(id, {new: true},(err, productoBorrado) => {
        ...
        productoBorrado.save((err, productoBorrado) => {
